<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManPage.aspx.cs" Inherits="ManPage.Index" %>
...
<body onload="getTecTasks('Manager', 'minus')">
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h4 style="display:inline-block;">Technicians Tasks</h4>
